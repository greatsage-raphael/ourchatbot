...
import type { Quiz as TQuiz } from "../../app/api/quiz/route";
...
const Quiz = ({
  ...
  return (
    <form className="flex flex-col gap-y-4 text-white" action={formAction}>
      <label className="font-medium text-xl text-white" htmlFor={id}>
...
export const QuizSet = ({ quizzes }: { quizzes: TQuiz[] }) => {
  ...
  return (
    <div className="text-white">
      ...
      <div className="space-y-48 pb-32 text-white">
      ...
      {numSubmitted ? (
        <div className="text-2xl font-bold text-center pb-24 text-white">
          Score: {numCorrect}/4
        </div>
      ) : null}
    </div>
